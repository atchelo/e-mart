...
<div class="box">
    ...
    <div class="box-header with-border">
        <div class="box-title">
            Edit Product Variant For <b>{{ $vars->products->name }}</b>
        </div>
    </div>
            ...
            <form action="{{ route('seller.updt.var',$vars->id) }}" method="POST" enctype="multipart/form-data">
               @csrf
                    ...
                    <div role="tabpanel" class="tab-pane" id="profile">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <small class="help-block">Please enter Price In Positive or Negative <br>
                ...
                <div class="col-md-12 form-group">
                    ...
                    <a href="{{ route('seller.add.var',$vars->products->id) }}"><button type="button"
