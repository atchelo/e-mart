...
<form id="demo-form2" method="post" enctype="multipart/form-data" @if(!empty($products))
  action="{{url('admindesk/products/'.$products->id)}}" @endif data-parsley-validate
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <br>
        <div class="row">
          <div class="col-md-4">
            <button type="submit" class="btn btn-block btn-primary"><i class="fa fa-save"></i> Update Product</button>
          </div>
        </div>
    </div>
