        ...
        <div class="col-md-10">
          <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane fade in active" id="lis">
                ...
                @include('admindesk/product/tab.edit.product')
              
            </div>
    
            <div role="tabpanel" class="fade tab-pane" id="prospec">
              @include('admindesk.product.tab.edit.productspec')
            </div>
    
            <div role="tabpanel" class="fade tab-pane" id="tags">
              @include('admindesk/product/tab.edit.faq')
            </div>
    
            <div role="tabpanel" class="fade tab-pane" id="rel">
              @include('admindesk/product/tab.edit.show_related')
            </div>
