...
@section('body')
	...
	<div class="box">
		<div class="box-header with-border">
			<div class="box-title">
				<a title="Back" href="{{ route('return.order.index') }}" class="back btn btn-md btn-default">
						...
						<td width="40%">
							<div class="col-md-2">
								@if($findvar->variantimages)
									<img class="pro-img" src="{{url('variantimages/'.$findvar->variantimages['main_image'])}}"/>
								@else
									<img class="pro-img" src="{{ Avatar::create($findvar->products->name) }}"/>
								@endif
							</div>
